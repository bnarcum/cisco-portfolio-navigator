...
(function () {
  ...
  const AVATAR_PRESETS = Object.freeze([
    { id: "classic", label: "Classic", config: { hair: "#43301f", hairStyle: "cap", shirt: "#1289b0", pants: "#2d3748", shoes: "#191f2b", face: "friendly", lanyardColor: "#161b24", eyeColor: "#2b3a4a", glasses: false, headAccessory: "none", height: 1 } },
    { id: "ocean", label: "Ocean", config: { hair: "#1a1208", hairStyle: "cap", shirt: "#049fd9", pants: "#1e293b", shoes: "#0f172a", face: "friendly", lanyardColor: "#0b3044", eyeColor: "#1e3a5f", glasses: false, headAccessory: "headset", height: 1 } },
    { id: "business", label: "Business", config: { hair: "#2c1810", hairStyle: "short", shirt: "#1e293b", pants: "#0f172a", shoes: "#020617", face: "neutral", lanyardColor: "#111827", eyeColor: "#334155", glasses: true, glassesColor: "#0f172a", headAccessory: "none", height: 1.02 } },
    { id: "night", label: "Night Ops", config: { hair: "#0a0a0a", hairStyle: "cap", shirt: "#14532d", pants: "#111827", shoes: "#000000", face: "friendly", lanyardColor: "#0a0f0a", eyeColor: "#4ade80", glasses: false, headAccessory: "hardhat", height: 0.98 } }
  ]);
  ...
  /**
   * Polished voxel field engineer — head with a face, hair, collared shirt
  ...
  function makeAvatar(THREE, config) {
    ...
    addHeadAccessory(THREE, head, cfg.headAccessory, {
      ...
      badge: blockMat(THREE, null, 0x64748b),
